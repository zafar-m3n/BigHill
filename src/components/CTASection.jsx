      ...
      <div className="max-w-5xl mx-auto">
        <RevealOnScroll direction="up">
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 w-48 h-48 rounded-full bg-[#D4A72C]/10 translate-y-1/3 -translate-x-1/3" />

            <div className="relative z-10">
              <div className="flex justify-center mb-4">
                <span className="px-4 py-1.5 rounded-full bg-[#D4A72C]/20 text-[#D4A72C] text-xs font-700 uppercase tracking-widest" style={{ fontWeight: 700 }}>
                  Become a Partner
                </span>
              </div>
              <h2
                className="text-white leading-tight mb-5"
                style={{ fontFamily: "'Instrument Serif', serif", fontWeight: 400, fontSize: 'clamp(1.8rem, 3.5vw, 2.5rem)' }}
              >
                {headline}
              </h2>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <Link
                  to={primaryTo}
                  className="px-8 py-3.5 rounded-full bg-white text-[#0E6B3C] font-700 text-sm hover:bg-[#FAF8F3] transition-all duration-200 hover:-translate-y-0.5 hover:shadow-xl flex items-center gap-2"
